...
try
{
	...
	ResultSet rs1 = st1.executeQuery("select * from users inner join cart where cart.email='" +email+"' and cart.status ='bill' ");
	while(rs1.next())
	{
%>
...
<div class="left-div"><h3>State: <%=rs1.getString(8) %> </h3></div>
